...
class AC_Model(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx): # Nearest Neighbour Search
        ...
        if not self.args.not_use_coreset_distribution:
            ...
            softmax_thres = softmax_temp  > 1 / 2048
            ...
            softmax_coor_inverse = np.zeros_like(softmax_coor)
            for i in range(neighbors.shape[0]) :
                for k in range(self.dist_coreset_index.ntotal) :
                    ...
                    softmax_coor_inverse[i, k] = softmax_coor[i, dist_indices[i, k]]
            ...
            anomaly_pxl_topk1 = np.sum(dist_distances * softmax_coor_inverse, axis = 1)
